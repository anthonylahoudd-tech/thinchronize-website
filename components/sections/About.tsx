...
const stats = [
  ...
  { value: '4',     label: 'Main Countries' },
  { value: '27+',   label: 'Industries' },
  ...
  return (
    <section ref={sectionRef} id="about" className="bg-dark section-padding">
      <div className="container mx-auto">
        ...
        {/* Body copy */}
        <div className="about-body grid grid-cols-1 md:grid-cols-12 gap-12 mb-16 md:mb-20">
        ...
        {/* Stats row */}
        <div className="about-stats grid grid-cols-2 md:grid-cols-4 gap-8 mb-20 md:mb-32">
          {stats.map((s) => (
