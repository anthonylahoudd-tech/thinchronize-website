...
export default function ServicesOrbitalClient() {
        ...
        <div style={{
          ...
          {stage === 'orbit' && (
            ...
            >
              ...
              <p style={{ fontFamily: PP, fontSize: 11, color: '#919191' }}>Tap to diagnose</p>
            </div>
          )}
        ...
        <>
          ...
          {stage === 'orbit' && (
            ...
            >
              ...
              <p style={{ fontFamily: PP, fontSize: 11, color: '#919191' }}>Click to diagnose</p>
            </div>
          )}
